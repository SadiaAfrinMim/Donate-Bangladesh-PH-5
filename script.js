...
function allAroundDonationFunction(inputID, availableMoneyID, addMoneyID,historyCommentID, event,addMoneyArray) {
...
document.getElementById('donateBtn').addEventListener('click', function(event) {
  allAroundDonationFunction('inputvalue', 'availablemoney', 'addMoney', 'fristtext',event,addMoneyArrayFrist);
});


document.getElementById('donateBtnSecond').addEventListener('click', function(event) {
  allAroundDonationFunction('inputvalueSecond', 'availablemoney', 'addMoneySecond', 'secondtext',event,addMoneyArraySecond);
});

document.getElementById('donateBtnthird').addEventListener('click', function(event) {
  allAroundDonationFunction('inputvaluethird', 'availablemoney', 'addMoneythird','thirdtext', event,addMoneyArrayThird);
});
